...
-- 知识信息表
-- TODO: Link直接存储在主表，提高查询和修改效率。但是以什么格式存储还是一个问题
...
-- TODO：使用数据库可以加一个Web层给前端查询， 但是原则上来说新增类型肯定要加很多代码，所以也可以直接Serer层搞定，不需要数据表
INSERT INTO app_type(id, name, code) VALUES (1, '英语单词本', 'EnglishWordNote'), (2, '力扣题解','LeetCode');
...
-- 用户自定义标签
INSERT INTO tag(name, creator) VALUES ('数据结构', 1), ('算法', 1);
...
INSERT INTO simple_review_rate(id) VALUES (1);